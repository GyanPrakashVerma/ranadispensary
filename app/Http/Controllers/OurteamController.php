...
class OurteamController extends Controller
{
    ...
    $ourteam->facebook_link = $request->facebook_link;
        ...
        $ourteam->insta_link = $request->insta_link;
        $ourteam->linkedin_link = $request->linkedin_link;
        $ourteam->pinterest_link = $request->pinterest_link;
        $ourteam->google_link = $request->google_link;
    $ourteam->save();
