    ...
    <div class="card-block">
        <form action="{{route('setting.update',$setting->id)}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="title" class="form-control-label">Mon-Sat:</label>
                        <input type="text" name="b_hour" class="form-control" id="" value="{{$setting->b_hour}}">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="title" class="form-control-label">Sun:</label>
                        <input type="text" name="b_hour_s" class="form-control" id="" value="{{$setting->b_hour_s}}">
                    </div>
                </div>
            </div>
            <div class="row">
