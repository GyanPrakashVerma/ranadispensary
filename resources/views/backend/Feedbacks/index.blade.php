    ...
    <div class="card" style="overflow:scroll">
        <div class="card-header">
            ...
            <a href="{{ route('feedback.create') }}"
                    class="text-dark"><button class="btn btn-outline-warning" style="float:right">Add Feedback</button></a>
        </div>
                        ...
                        <tbody>
                            ...
                            @foreach ($feedback as $feeds)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('feedback.destroy',$feeds->id) }}" method="POST">
                                            @csrf
                                            @method('Delete')
                                            <a href="{{ route('feedback.edit',$feeds->id) }}" class="btn btn-success"><i
